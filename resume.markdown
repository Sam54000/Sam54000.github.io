...
<div class="tui-section">
    <div class="tui-section-content">
        ...
        <strong class="highlight">Location:</strong> Onsite | Hybrid | Remote
    </div>
</div>
    ...
    <div class="tui-section-content">
        <div class="experience-item">
            ...
            <ul>
                ...
                <li>Built Python pipelines for multimodal data (EEG, fMRI, eye-tracking) processing and optimized for machine learning training</li>
                <li>Designed EEG data cleaning and quality assessment pipelines for a 260-human subject cohort on Linux servers</li>
                <li>Developed a Python package dedicated to EEG research</li>
                <li>Mentored 2 Data Analysts, 1 Undergraduate, and 1 Graduate student in data analysis and machine learning techniques</li>
            </ul>
        </div>
        <div class="experience-item">
            ...
            <ul>
                ...
                <li>Researched and trained machine learning models for Brain-Computer Interfaces (BCI), reaching 60% accuracy</li>
                <li>Conducted Big Data analytics on a multimodal dataset of 140+ participants</li>
                <li>Collaborated with engineers in academia and industry to develop high-density closed-loop transcranial electrical stimulation systems</li>
                <li>Curated and managed a NoSQL database (100TB) for medical data</li>
                <li>Mentored 1 PhD student and 1 undergraduate student</li>
            </ul>
        </div>
        <div class="experience-item">
            ...
            <ul>
                ...
                <li>Mentored 3 undergraduate students in data analysis and research techniques</li>
            </ul>
        </div>
        <div class="experience-item">
...
<div class="tui-section">
    ...
    <div class="tui-section-content">
        <ul>
            <li><strong class="highlight">French:</strong> Native</li>
            <li><strong class="highlight">English:</strong> Fluent</li>
            <li><strong class="highlight">Spanish:</strong> Conversational</li>
        </ul>
    </div>
</div>
