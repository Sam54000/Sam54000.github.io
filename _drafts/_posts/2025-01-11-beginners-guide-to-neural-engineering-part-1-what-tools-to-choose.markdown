...
There has been a resurgence of interest and activity around neuro-whatever businesses in the last few years. A good case in point is the current craze for so-called ‘brain training’ products (and a lot of neuro-bullsh*t, pardon my French). It’s a buzzword, though its hype has been somewhat overshadowed by AI/LLMs/Generative AI lately. But still, media go crazy every time "brain-computer interface" is mentioned. I’ve heard many excited students say they were going to cure Alzheimer's, Parkinson’s, or whatnot!

Cute.

But things become more complicated when it comes to getting our hands dirty dealing with real-world neural data. And it can be daunting for those just getting in. Where to start? How do I analyze the data? What programming language? What package? In this serie I will scratch
the surface about neural engineering, I will give a bird's view of what neural engineering consists of, how to get started and why we should not treat neural data like any other data.
This will come from my personal experience and what you will read is only my opinion from
this experience.

# M vs. Python: The Eternal Debate

When I started working with EEG data, my first experience was with MATLAB. MATLAB is the go-to for many labs, primarily because of its comprehensive built-in toolboxes and ease of use for signal processing. You just have to install matlab on your computer and that's it, you can start
"coding".

But here’s the catch: MATLAB is not free. As an academic, I had access to it through my institution, but the moment I left, it became clear that sticking to MATLAB meant being locked into a costly ecosystem. In addition, knowing MATLAB Plus, I strongly believe in open science, and proprietary software is fundamentally at odds with that philosophy.
